...
<head>
    ...
    <title>Smart Ingeniería — Proyectos</title>
    <style>
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .progress-bar{height:6px;background:#27272a;border-radius:3px;overflow:hidden;margin-top:4px}
...
<div class="main">
    <div class="topbar">
        <div>
            <p style="color:#fff;font-weight:700;font-size:15px">Gestión de Proyectos</p>
            <p style="color:#71717a;font-size:12px">Crear y administrar proyectos</p>
        </div>
       <div class="user-menu">
    ...
    <div class="content">
        ...
        <div class="form-card">
            <p class="form-title">+ Nuevo Proyecto</p>
        ...
        <div class="section">
            <div class="section-head">
                <span class="section-title">🏗️ Todos los proyectos</span>
                <input type="text" class="buscador" id="buscadorProyecto"
                    placeholder="🔍 Buscar proyecto..." onkeyup="filtrarProyectos()"/>
            </div>
                        ...
                        <tr>
                            <td>
                                ...
                                @if($proyecto->descripcion)
                                    <p style="color:#71717a;font-size:11px;margin-top:2px">{{ Str::limit($proyecto->descripcion, 50) }}</p>
                                @endif
                            </td>
                            ...
                            <td style="min-width:100px">
                                <p style="font-size:11px;color:#a1a1aa;margin-bottom:2px">{{ number_format($porcentaje, 0) }}%</p>
                            ...
                            <td>
                                <a href="{{ route('admin.proyectos.editar', $proyecto->id) }}"
...
function filtrarProyectos() {
    const input = document.getElementById('buscadorProyecto').value.toLowerCase();
