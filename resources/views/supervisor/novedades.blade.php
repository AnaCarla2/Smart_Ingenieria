...
<div class="main">
    <div class="topbar">
        <div>
            ...
            <p style="color:#71717a;font-size:12px">Permisos, ausencias e incapacidades</p>
        </div>
        <div class="user-menu">
    ...
    <div class="content">
        ...
        <div class="form-card">
            <p class="form-title">+ Registrar novedad</p>
            <form method="POST" action="{{ route('supervisor.novedades.guardar') }}">
                ...
                <div class="field" style="margin-bottom:12px">
                    ...
                    <textarea name="descripcion" rows="2"
                        placeholder="Detalle de la novedad..." required></textarea>
                </div>
        ...
        <div class="section">
            <div class="section-head">
                ...
                <span style="color:#71717a;font-size:12px">{{ $novedades->count() }} registros</span>
            </div>
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    @forelse($novedades as $novedad)
                        <tr>
                            ...
                            <td style="color:#a1a1aa;font-size:12px">{{ Str::limit($novedad->descripcion, 50) }}</td>
                            <td>
