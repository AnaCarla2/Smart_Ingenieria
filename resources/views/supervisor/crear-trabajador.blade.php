...
<div class="main">
    <div class="topbar">
        ...
        <a href="{{ route('supervisor.trabajadores') }}" class="btn btn-gris">← Volver</a>
    </div>
    ...
    <div class="content">
        ...
        <div class="form-card">
            <form method="POST" action="{{ route('supervisor.trabajadores.guardar') }}">
                @csrf
                ...
                <div class="grid-2">
                    ...
                    <div class="field">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" placeholder="juan@empresa.com" required/>
                    </div>
                </div>
                ...
                <div class="grid-2">
                    <div class="field">
                        ...
                        <input type="text" name="cedula" value="{{ old('cedula') }}" placeholder="Ej: 1023456789" required/>
                    </div>
                    <div class="field">
                ...
                <div class="grid-2">
                    ...
                    <div class="field">
                        ...
                        <input type="number" name="salario" value="{{ old('salario') }}" placeholder="Ej: 2800000" min="0" required/>
                    </div>
                </div>
                ...
                <div style="display:flex;gap:12px;margin-top:8px">
                    ...
                    <a href="{{ route('supervisor.trabajadores') }}" class="btn btn-gris">Cancelar</a>
                </div>
